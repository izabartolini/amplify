  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        notifications.show({
          title: "Erro",
          message: error.error || "Erro ao atualizar evento.",
          color: "red",
        });
      }
    } catch (error) {
  ...
  if (!event) {
    return (
      <div className="event-details-page">
        <Navbar />
        <Center style={{ height: '70vh' }}>
          <Text size="xl">Evento não encontrado.</Text>
        </Center>
      </div>
    );
  }
          ...
          {isEditing ? (
            <Stack mt="md" spacing="sm">
              ...
              <Checkbox
                ...
                onChange={(e) => setEditData({ ...editData, is_private: e.currentTarget.checked })}
              />

              <Group mt="md">
                <Button onClick={handleSaveEdit} loading={isSaving} color="green">
                  Salvar Alterações
                </Button>
            ...
            <>
              ...
              <div className="event-details-meta">
                ...
                {event.is_private && (
                  <span className="event-details-private">🔒 Evento privado</span>
                )}
              </div>
              ...
              {!isOwner && (
                event.is_private ? (
                  ...
                  <Button
                    ...
                    fullWidth
                  >
                    {hasRequested ? "✓ Você já participa deste evento" : "Participar"}
                  </Button>
                )
              )}
            </>
